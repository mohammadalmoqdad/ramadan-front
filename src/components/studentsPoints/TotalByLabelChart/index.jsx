...
export default function TotalByLabelChart({ selectedUser }) {
    ...
    if(selectedUser === ""){
        return <div style={{ width: '100%' }} className="table-msg-text-section"><H5>اختر الطالب لعرض الإحصائيات لكل معييار</H5></div>;
    }

    if(chartData.length ===0){
        return <div style={{ width: '100%' }} className="table-msg-text-section"><H5>لا يوجد نقاط لعرض الإحصائيات لكل معييار</H5></div>;
    }
