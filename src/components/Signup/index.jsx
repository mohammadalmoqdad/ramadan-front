...
import {FileFormInput} from "../Students/setPasswordStudent/SetPasswordStudent.styles";
        ...
        <SignupFormContainer>
            <DivCenter>
                <HeadLogIn>
                    ...
                    <SignupNowAccount>Already have an account? <SignupNow href="/Login">Login
                        now!</SignupNow></SignupNowAccount>
                </HeadLogIn>
                ...
                <Form onSubmit={handleSubmit}>
                    ...
                    {!isValidUserName &&
                        <DivPass className={classColor}>Username can contain Letters, digits and @/./+/-/_
                            only.</DivPass>
                    }
                    ...
                    {showErrorMessageMatch && (
                        <DivPass className="red">These passwords didn't match. Try again.</DivPass>
                    )}
